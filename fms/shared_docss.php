...
function folder_id_clause($folder_parent){
	if(!empty($folder_parent)){
		return " and folders.id = " . $folder_parent;
	}else{
		return "";
	}
}
...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12"><h4 style="padding-top: 10px;"><b>Shared DOCSS</b></h4></div>
	</div>
	<hr>
	<div class="col-lg-12">
			...
			<div class="col-lg-12">
				<form action="index.php" method="get">
					<div class="input-group ">
						...
						<input type="text" placeholder="Search File" class="form-control" name="q" value="<?php echo isset($_GET['q']) ? $_GET['q'] : ''?>">
					</div>
					<input type="hidden" name="page" value="shared_docss">
				</form>
			</div>
		</div>
		<hr>
